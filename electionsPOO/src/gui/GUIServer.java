 ...
 * @author IPT
 */
public class GUIServer extends javax.swing.JFrame implements MiningListener {
     ...
     */
    public GUIServer(int port, int px, int py) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lstBlockchain1 = new javax.swing.JList<>();
        pnLabelCenter2 = new javax.swing.JPanel();
        jLabel10 = new javax.swing.JLabel();
        jScrollPane10 = new javax.swing.JScrollPane();
        txtBlockchain1 = new javax.swing.JTextArea();
        ...
        pnElection = new javax.swing.JPanel();
        pnBlockchianTop4 = new javax.swing.JPanel();
        ...
        pnLabelCenter3 = new javax.swing.JPanel();
        jLabel12 = new javax.swing.JLabel();
        jScrollPane12 = new javax.swing.JScrollPane();
        txtCandidates = new javax.swing.JTextArea();
        pnElectors = new javax.swing.JPanel();
        pnBlockchianTop3 = new javax.swing.JPanel();
        pnLabelLeft4 = new javax.swing.JPanel();
        jLabel13 = new javax.swing.JLabel();
        jScrollPane13 = new javax.swing.JScrollPane();
        lstElectors = new javax.swing.JList<>();
        pnLabelCenter4 = new javax.swing.JPanel();
        jLabel14 = new javax.swing.JLabel();
        jScrollPane14 = new javax.swing.JScrollPane();
        txtElectors = new javax.swing.JTextArea();
        ...
        pnLabelLeft2.add(jLabel9, java.awt.BorderLayout.PAGE_START);

        jScrollPane9.setMaximumSize(new java.awt.Dimension(32767, 200));

        lstBlockchain1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        lstBlockchain1.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                lstBlockchain1ValueChanged(evt);
            }
        });
        jScrollPane9.setViewportView(lstBlockchain1);
        ...
        txtBlockchain1.setColumns(20);
        txtBlockchain1.setFont(new java.awt.Font("Courier New", 1, 14)); // NOI18N
        txtBlockchain1.setRows(5);
        txtBlockchain1.setMaximumSize(new java.awt.Dimension(300, 900000));
        txtBlockchain1.setOpaque(false);
        jScrollPane10.setViewportView(txtBlockchain1);
        ...
        pnLabelLeft1.add(jLabel7, java.awt.BorderLayout.PAGE_START);
        ...
        pnElection.setLayout(new java.awt.BorderLayout());

        pnBlockchianTop4.setLayout(new java.awt.GridLayout(1, 0));

        pnLabelLeft5.setLayout(new java.awt.BorderLayout());

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel15.setText("Elections");
        jLabel15.setPreferredSize(new java.awt.Dimension(200, 16));
        pnLabelLeft5.add(jLabel15, java.awt.BorderLayout.PAGE_START);
        ...
        pnBlockchianTop4.add(pnLabelLeft5);

        pnLabelCenter5.setLayout(new java.awt.BorderLayout());

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("Details");
        pnLabelCenter5.add(jLabel16, java.awt.BorderLayout.NORTH);
        ...
        pnBlockchianTop4.add(pnLabelCenter5);

        pnElection.add(pnBlockchianTop4, java.awt.BorderLayout.CENTER);

        tpMain.addTab("Election", pnElection);

        pnCandidates.setLayout(new java.awt.BorderLayout());

        pnBlockchianTop2.setLayout(new java.awt.GridLayout(1, 0));
        ...
        pnLabelLeft3.add(jLabel11, java.awt.BorderLayout.PAGE_START);

        jScrollPane11.setMaximumSize(new java.awt.Dimension(32767, 200));
        ...
        jScrollPane11.setViewportView(lstCandidates);

        pnLabelLeft3.add(jScrollPane11, java.awt.BorderLayout.CENTER);

        pnBlockchianTop2.add(pnLabelLeft3);

        pnLabelCenter3.setLayout(new java.awt.BorderLayout());

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("Details");
        pnLabelCenter3.add(jLabel12, java.awt.BorderLayout.NORTH);

        jScrollPane12.setMaximumSize(new java.awt.Dimension(300, 900000));
        ...
        jScrollPane12.setViewportView(txtCandidates);

        pnLabelCenter3.add(jScrollPane12, java.awt.BorderLayout.CENTER);

        pnBlockchianTop2.add(pnLabelCenter3);

        pnCandidates.add(pnBlockchianTop2, java.awt.BorderLayout.CENTER);

        tpMain.addTab("Candidates", pnCandidates);

        pnElectors.setLayout(new java.awt.BorderLayout());

        pnBlockchianTop3.setLayout(new java.awt.GridLayout(1, 0));

        pnLabelLeft4.setLayout(new java.awt.BorderLayout());

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel13.setText("Electors");
        jLabel13.setPreferredSize(new java.awt.Dimension(200, 16));
        pnLabelLeft4.add(jLabel13, java.awt.BorderLayout.PAGE_START);

        jScrollPane13.setMaximumSize(new java.awt.Dimension(32767, 200));

        lstElectors.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jScrollPane13.setViewportView(lstElectors);

        pnLabelLeft4.add(jScrollPane13, java.awt.BorderLayout.CENTER);

        pnBlockchianTop3.add(pnLabelLeft4);

        pnLabelCenter4.setLayout(new java.awt.BorderLayout());

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("Details");
        pnLabelCenter4.add(jLabel14, java.awt.BorderLayout.NORTH);

        jScrollPane14.setMaximumSize(new java.awt.Dimension(300, 900000));
        jScrollPane14.setOpaque(false);

        txtElectors.setColumns(20);
        txtElectors.setFont(new java.awt.Font("Courier New", 1, 14)); // NOI18N
        txtElectors.setRows(5);
        txtElectors.setMaximumSize(new java.awt.Dimension(300, 900000));
        txtElectors.setOpaque(false);
        jScrollPane14.setViewportView(txtElectors);

        pnLabelCenter4.add(jScrollPane14, java.awt.BorderLayout.CENTER);

        pnBlockchianTop3.add(pnLabelCenter4);

        pnElectors.add(pnBlockchianTop3, java.awt.BorderLayout.CENTER);

        tpMain.addTab("Electors", pnElectors);
    ...
    private void lstBlockchain1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstBlockchain1ValueChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_lstBlockchain1ValueChanged
    ...
    private void lstCandidatesValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstCandidatesValueChanged
        ...
        try{
            if (lstCandidates.getSelectedIndex() >= 0) {
                CandidateBean candidate = myRemote.getCandidateList().get(lstCandidates.getSelectedIndex());

                StringBuilder txt = new StringBuilder();

                //adicionar o candidato
                txt.append(":::::::::::::::::\n");
                txt.append("Initials: " + candidate.getInitials()).append("\n");
                txt.append("Name: " + candidate.getName()).append("\n");

                txtCandidates.setText(txt.toString());
            }
    ...
    private void lstElectorsValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstElectorsValueChanged
        ...
        try{
            if (lstElectors.getSelectedIndex() >= 0) {
                ElectorBean elector = myRemote.getElectorsList().get(lstElectors.getSelectedIndex());

                StringBuilder txt = new StringBuilder();

                //adicionar o candidato
                txt.append(":::::::::::::::::\n");
                txt.append("Name: " + elector.getName()).append("\n");
                txt.append("CC: " + elector.getCC()).append("\n");
                txt.append("Gender: " + elector.getGender()).append("\n");
                txt.append("Birthdate: " + elector.getBirthDate()).append("\n");

                txtElectors.setText(txt.toString());
            }
        }catch(RemoteException e){
            System.out.println("Erro a listar detalhes");
        }
    ...
    private javax.swing.JPanel pnBlockchianTop2;
    private javax.swing.JPanel pnBlockchianTop3;
    private javax.swing.JPanel pnBlockchianTop4;
    private javax.swing.JPanel pnCandidates;
    private javax.swing.JPanel pnElection;
    private javax.swing.JPanel pnElectors;
    ...
    private javax.swing.JPanel pnLabelCenter3;
    private javax.swing.JPanel pnLabelCenter4;
    private javax.swing.JPanel pnLabelCenter5;
    private javax.swing.JPanel pnLabelLeft;
    private javax.swing.JPanel pnLabelLeft1;
    private javax.swing.JPanel pnLabelLeft2;
    private javax.swing.JPanel pnLabelLeft3;
    private javax.swing.JPanel pnLabelLeft4;
    private javax.swing.JPanel pnLabelLeft5;
    ...
    public void onUpdateCandidates() {
        EventQueue.invokeLater(() -> {
            try {
                ...
                for (int i = 0; i < myRemote.getCandidateList().size(); i++) {
                    model.addElement(myRemote.getCandidateList().get(i).getName());
                }
                lstCandidates.setModel(model);
                //selecionar o último bloco
                lstCandidates.setSelectedValue(myRemote.getCandidateList().size() - 1, true);
                tpMain.setSelectedComponent(pnCandidates);
            } catch (RemoteException ex) {
                onException("onReceiveTransaction", ex);
            }
        });
    ...
    public void onUpdateElectors() {
        EventQueue.invokeLater(() -> {
            try {
                ...
                DefaultListModel<String> model = new DefaultListModel<>();
                //nao introduzir o primeiro elemento
                for (int i = 0; i < myRemote.getElectorsList().size(); i++) {
                    model.addElement(myRemote.getElectorsList().get(i).getName());
                }
                lstElectors.setModel(model);
                //selecionar o último bloco
                lstElectors.setSelectedValue(myRemote.getElectorsList().size() - 1, true);
